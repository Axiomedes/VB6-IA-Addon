...
#If False Then
  ...
  Private CCBackStyleTransparent, CCBackStyleOpaquíe
...
#Else
  ...
  Public Declare Function ComCtlsObjAddRef _
                 Lib "msvbvm60.dll" _
                 Alias "__vbaObjAddref" (ByVal lpObject As Long) As Long

  Public Declare Function ComCtlsObjSet _
                 Lib "msvbvm60.dll" _
                 Alias "__vbaObjSet" (ByRef Destination As Any, _
                                      ByVal lpObject As Long) As Long

  Public Declare Function ComCtlsObjSetAddRef _
                 Lib "msvbvm60.dll" _
                 Alias "__vbaObjSetAddref" (ByRef Destination As Any, _
                                            ByVal lpObject As Long) As Long
  ...
  Private Declare Function PeekMessage _
                  Lib "user32" _
                  Alias "PeekMessageW" (ByRef lpMsg As TMSG, _
  ...
  Private Declare Function DefWindowProc _
                  Lib "user32" _
                  Alias "DefWindowProcW" (ByVal hWnd As Long, _
                                          ByVal wMsg As Long, _
                                          ByVal wParam As Long, _
  ...
  Private Declare Function GetKeyboardLayout _
                  Lib "user32" (ByVal dwThreadID As Long) As Long
  ...
  Private Declare Function ImmReleaseContext _
                  Lib "imm32" (ByVal hWnd As Long, _
                               ByVal hIMC As Long) As Long

  Private Declare Function ImmGetOpenStatus Lib "imm32" (ByVal hIMC As Long) As Long

  Private Declare Function ImmSetOpenStatus _
                  Lib "imm32" (ByVal hIMC As Long, _
                               ByVal fOpen As Long) As Long

  Private Declare Function ImmAssociateContext _
                  Lib "imm32" (ByVal hWnd As Long, _
                               ByVal hIMC As Long) As Long

  Private Declare Function ImmGetConversionStatus _
                  Lib "imm32" (ByVal hIMC As Long, _
                               ByVal lpfdwConversion As Long, _
                               ByVal lpfdwSentence As Long) As Long
  ...
  Private Declare Function TrackMouseEvent _
                  Lib "user32" (ByRef lpEventTrack As TRACKMOUSEEVENTSTRUCT) As Long
  ...
  Private Declare Function GetLocaleInfo _
                  Lib "kernel32" _
                  Alias "GetLocaleInfoW" (ByVal LCID As Long, _
                                          ByVal LCType As Long, _
                                          ByVal lpLCData As Long, _
                                          ByVal cchData As Long) As Long

  Private Declare Function IsDialogMessage _
                  Lib "user32" _
                  Alias "IsDialogMessageW" (ByVal hDlg As Long, _
                                            ByRef lpMsg As TMSG) As Long

  Private Declare Function DllGetVersion _
                  Lib "comctl32" (ByRef pdvi As DLLVERSIONINFO) As Long

  Private Declare Function GetModuleHandle _
                  Lib "kernel32" _
                  Alias "GetModuleHandleW" (ByVal lpModuleName As Long) As Long
  ...
  Private Declare Function ImageList_DrawEx _
                  Lib "comctl32" (ByVal hImageList As Long, _
  ...
  Private Declare Function SetProp _
                  Lib "user32" _
                  Alias "SetPropW" (ByVal hWnd As Long, _
                                    ByVal lpString As Long, _
                                    ByVal hData As Long) As Long

  Private Declare Function GetProp _
                  Lib "user32" _
                  Alias "GetPropW" (ByVal hWnd As Long, _
                                    ByVal lpString As Long) As Long

  Private Declare Function RemoveProp _
                  Lib "user32" _
                  Alias "RemovePropW" (ByVal hWnd As Long, _
                                       ByVal lpString As Long) As Long

  Private Declare Function SetWindowSubclass _
                  Lib "comctl32" (ByVal hWnd As Long, _
  ...
  Private Declare Function SetWindowSubclassW2K _
                  Lib "comctl32" _
  ...
  Private Declare Function RemoveWindowSubclassW2K _
                  Lib "comctl32" _
                  Alias "#412" (ByVal hWnd As Long, _
                                ByVal pfnSubclass As Long, _
                                ByVal uIdSubclass As Long) As Long

  Private Declare Function DefSubclassProcW2K _
                  Lib "comctl32" _
...
Public Sub ComCtlsInitBorderStyle(ByRef dwStyle As Long, _
                                  ByRef dwExStyle As Long, _
                                  ByVal Value As CCBorderStyleConstants)
...
#If VBA7 Then
  Public Sub ComCtlsChangeBorderStyle(ByVal hWnd As LongPtr, _
                                      ByVal Value As CCBorderStyleConstants)
  #Else
...
#If VBA7 Then
  Public Sub ComCtlsSetIMEMode(ByVal hWnd As LongPtr, _
                               ByVal hIMCOrig As LongPtr, _
                               ByVal Value As CCIMEModeConstants)
  #Else
...
Public Sub ComCtlsCheckRightToLeft(ByRef Value As Boolean, _
                                   ByVal UserControlValue As Boolean, _
                                   ByVal ModeValue As CCRightToLeftModeConstants)
...
Public Sub ComCtlsIPPBSetPredefinedStringsImageList(ByRef StringsOut() As String, _
                                                    ByRef CookiesOut() As Long, _
                                                    ByRef ControlsEnum As VBRUN.ParentControls, _
                                                    ByRef ImageListArray() As String)
...
Public Sub ComCtlsSetSubclass(ByVal hWnd As Long, _
                              ByVal This As ISubclass, _
...
#If VBA7 Then
  Public Function ComCtlsDefaultProc(ByVal hWnd As LongPtr, _
                                     ByVal wMsg As Long, _
...
#If VBA7 Then
  Public Function ComCtlsSubclassProc(ByVal hWnd As LongPtr, _
                                      ByVal wMsg As Long, _
                                      ByVal wParam As LongPtr, _
...
Public Sub ComCtlsImlListImageIndex(ByVal Control As Object, _
                                    ByVal ImageList As Variant, _
                                    ByVal KeyOrIndex As Variant, _
                                    ByRef ImageIndex As Long)
...
Public Sub ComCtlsImcGetSysColorSetHook(ByVal RGBBackColor As Long, _
                                        ByVal RGBForeColor As Long)
...
#If VBA7 Then
  Private Function ComCtlsImcImageListDrawProc(ByVal hImageList As LongPtr, _
                                               ByVal ImgIndex As Long, _
...
#If VBA7 Then
  Public Function ComCtlsCbrPlaceholderWindowProc(ByVal hWnd As LongPtr, _
                                                  ByVal wMsg As Long, _
                                                  ByVal wParam As LongPtr, _
                                                  ByVal lParam As LongPtr) As LongPtr
  #Else
...
#If VBA7 Then
  Public Function ComCtlsTbrEnumThreadWndProc(ByVal hWnd As LongPtr, _
...
#If VBA7 Then
  Public Function ComCtlsLvwSortingFunctionBinary(ByVal lParam1 As LongPtr, _
                                                  ByVal lParam2 As LongPtr, _
                                                  ByVal This As ISubclass) As Long
  #Else
...
#If VBA7 Then
  Public Function ComCtlsLvwSortingFunctionText(ByVal lParam1 As LongPtr, _
                                                ByVal lParam2 As LongPtr, _
                                                ByVal This As ISubclass) As Long
  #Else
...
#If VBA7 Then
  Public Function ComCtlsLvwSortingFunctionNumeric(ByVal lParam1 As LongPtr, _
                                                   ByVal lParam2 As LongPtr, _
                                                   ByVal This As ISubclass) As Long
  #Else
...
#If VBA7 Then
  Public Function ComCtlsLvwSortingFunctionCurrency(ByVal lParam1 As LongPtr, _
                                                    ByVal lParam2 As LongPtr, _
                                                    ByVal This As ISubclass) As Long
  #Else
...
#If VBA7 Then
  Public Function ComCtlsLvwSortingFunctionDate(ByVal lParam1 As LongPtr, _
                                                ByVal lParam2 As LongPtr, _
                                                ByVal This As ISubclass) As Long
  #Else
...
#If VBA7 Then
  Public Function ComCtlsLvwSortingFunctionLogical(ByVal lParam1 As LongPtr, _
                                                   ByVal lParam2 As LongPtr, _
                                                   ByVal This As ISubclass) As Long
  #Else
...
#If VBA7 Then
  Public Function ComCtlsLvwSortingFunctionGroups(ByVal lParam1 As LongPtr, _
                                                  ByVal lParam2 As LongPtr, _
                                                  ByVal This As ISubclass) As Long
  #Else
...
#If VBA7 Then
  Public Function ComCtlsTvwSortingFunctionBinary(ByVal lParam1 As LongPtr, _
                                                  ByVal lParam2 As LongPtr, _
                                                  ByVal This As ISubclass) As Long
  #Else
...
#If VBA7 Then
  Public Function ComCtlsTvwSortingFunctionText(ByVal lParam1 As LongPtr, _
                                                ByVal lParam2 As LongPtr, _
                                                ByVal This As ISubclass) As Long
  #Else
...
#If VBA7 Then
  Public Function ComCtlsFtcEnumFontFunction(ByVal lpELF As LongPtr, _
                                             ByVal lpTM As LongPtr, _
...
#If VBA7 Then
  Public Function ComCtlsCdlOFN1CallbackProc(ByVal hDlg As LongPtr, _
                                             ByVal wMsg As Long, _
                                             ByVal wParam As LongPtr, _
                                             ByVal lParam As LongPtr) As LongPtr
  #Else
...
#If VBA7 Then
  Public Function ComCtlsCdlOFN1CallbackProcOldStyle(ByVal hDlg As LongPtr, _
                                                     ByVal wMsg As Long, _
                                                     ByVal wParam As LongPtr, _
                                                     ByVal lParam As LongPtr) As LongPtr
  #Else
...
#If VBA7 Then
  Public Function ComCtlsCdlOFN2CallbackProc(ByVal hDlg As LongPtr, _
                                             ByVal wMsg As Long, _
                                             ByVal wParam As LongPtr, _
                                             ByVal lParam As LongPtr) As LongPtr
  #Else
...
#If VBA7 Then
  Public Function ComCtlsCdlOFN2CallbackProcOldStyle(ByVal hDlg As LongPtr, _
                                                     ByVal wMsg As Long, _
                                                     ByVal wParam As LongPtr, _
                                                     ByVal lParam As LongPtr) As LongPtr
  #Else
...
#If VBA7 Then
  Public Function ComCtlsCdlCCCallbackProc(ByVal hDlg As LongPtr, _
                                           ByVal wMsg As Long, _
                                           ByVal wParam As LongPtr, _
                                           ByVal lParam As LongPtr) As LongPtr
  #Else
...
#If VBA7 Then
  Public Function ComCtlsCdlCFCallbackProc(ByVal hDlg As LongPtr, _
                                           ByVal wMsg As Long, _
                                           ByVal wParam As LongPtr, _
                                           ByVal lParam As LongPtr) As LongPtr
  #Else
...
#If VBA7 Then
  Public Function ComCtlsCdlPDCallbackProc(ByVal hDlg As LongPtr, _
                                           ByVal wMsg As Long, _
                                           ByVal wParam As LongPtr, _
                                           ByVal lParam As LongPtr) As LongPtr
  #Else
...
Private Function IPDCB_QueryInterface(ByVal Ptr As LongPtr, _
                                      ByRef IID As CLSID, _
                                      ByRef pvObj As LongPtr) As Long
  ...
  If IID.Data1 = &H5852A2C3 And IID.Data2 = &H6530 And IID.Data3 = &H11D1 Then
    If IID.Data4(0) = &HB6 And IID.Data4(1) = &HA3 And IID.Data4(2) = &H0 And IID.Data4(3) = &H0 And IID.Data4(4) = &HF8 And IID.Data4(5) = &H75 And IID.Data4(6) = &H7B And IID.Data4(7) = &HF9 Then
      pvObj = Ptr
      IPDCB_AddRef Ptr
...
Private Function IPDCB_HandleMessage(ByVal Ptr As LongPtr, _
                                     ByVal hDlg As LongPtr, _
                                     ByVal wMsg As Long, _
                                     ByVal wParam As LongPtr, _
                                     ByVal lParam As LongPtr, _
                                     ByRef Result As LongPtr) As Long
...
#If VBA7 Then
  Public Function ComCtlsCdlPSDCallbackProc(ByVal hDlg As LongPtr, _
                                            ByVal wMsg As Long, _
                                            ByVal wParam As LongPtr, _
                                            ByVal lParam As LongPtr) As LongPtr
  #Else
...
#If VBA7 Then
  Public Function ComCtlsCdlBIFCallbackProc(ByVal hDlg As LongPtr, _
                                            ByVal wMsg As Long, _
                                            ByVal lParam As LongPtr, _
                                            ByVal This As ISubclass) As Long
  #Else
...
#If VBA7 Then
  Public Function ComCtlsCdlFR1CallbackProc(ByVal hDlg As LongPtr, _
                                            ByVal wMsg As Long, _
                                            ByVal wParam As LongPtr, _
                                            ByVal lParam As LongPtr) As LongPtr
  #Else
...
#If VBA7 Then
  Public Function ComCtlsCdlFR2CallbackProc(ByVal hDlg As LongPtr, _
                                            ByVal wMsg As Long, _
                                            ByVal wParam As LongPtr, _
                                            ByVal lParam As LongPtr) As LongPtr
  #Else
...
Private Function ComCtlsCdlFRHookProc(ByVal nCode As Long, _
                                      ByVal wParam As LongPtr, _
                                      ByVal lParam As LongPtr) As LongPtr
