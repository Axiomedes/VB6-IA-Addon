...
#Else
  ...
  Private Declare Function lstrcpy _
                  Lib "kernel32" _
                  Alias "lstrcpyW" (ByVal lpString1 As Long, _
                                    ByVal lpString2 As Long) As Long

  Private Declare Function MessageBoxIndirect _
                  Lib "user32" _
                  Alias "MessageBoxIndirectW" (ByRef lpMsgBoxParams As MSGBOXPARAMS) As Long
  ...
  Private Declare Function GetFileAttributes _
                  Lib "kernel32" _
                  Alias "GetFileAttributesW" (ByVal lpFileName As Long) As Long

  Private Declare Function SetFileAttributes _
                  Lib "kernel32" _
                  Alias "SetFileAttributesW" (ByVal lpFileName As Long, _
                                              ByVal dwFileAttributes As Long) As Long

  Private Declare Function GetFileAttributesEx _
                  Lib "kernel32" _
                  Alias "GetFileAttributesExW" (ByVal lpFileName As Long, _
                                                ByVal fInfoLevelId As Long, _
                                                ByVal lpFileInformation As Long) As Long

  Private Declare Function FileTimeToLocalFileTime _
                  Lib "kernel32" (ByVal lpFileTime As Long, _
                                  ByVal lpLocalFileTime As Long) As Long

  Private Declare Function LocalFileTimeToFileTime _
                  Lib "kernel32" (ByVal lpLocalFileTime As Long, _
                                  ByVal lpFileTime As Long) As Long
  ...
  Private Declare Function SystemTimeToFileTime _
                  Lib "kernel32" (ByVal lpSystemTime As Long, _
                                  ByVal lpFileTime As Long) As Long

  Private Declare Function FindFirstFile _
                  Lib "kernel32" _
                  Alias "FindFirstFileW" (ByVal lpFileName As Long, _
                                          ByRef lpFindFileData As WIN32_FIND_DATA) As Long

  Private Declare Function FindNextFile _
                  Lib "kernel32" _
                  Alias "FindNextFileW" (ByVal hFindFile As Long, _
                                         ByRef lpFindFileData As WIN32_FIND_DATA) As Long

  Private Declare Function FindClose Lib "kernel32" (ByVal hFindFile As Long) As Long

  Private Declare Function SystemTimeToTzSpecificLocalTime _
                  Lib "kernel32" (ByVal lpTimeZoneInformation As Long, _
                                  ByVal lpUniversalTime As Long, _
                                  ByVal lpLocalTime As Long) As Long

  Private Declare Function TzSpecificLocalTimeToSystemTime _
                  Lib "kernel32" (ByVal lpTimeZoneInformation As Long, _
                                  ByVal lpLocalTime As Long, _
                                  ByVal lpUniversalTime As Long) As Long
  ...
  Private Declare Function GetMonitorInfo _
                  Lib "user32" _
                  Alias "GetMonitorInfoW" (ByVal hMonitor As Long, _
                                           ByRef lpMI As MONITORINFO) As Long

  Private Declare Function GetVolumePathName _
                  Lib "kernel32" _
                  Alias "GetVolumePathNameW" (ByVal lpFileName As Long, _
                                              ByVal lpVolumePathName As Long, _
                                              ByVal cch As Long) As Long

  Private Declare Function GetVolumeInformation _
                  Lib "kernel32" _
                  Alias "GetVolumeInformationW" (ByVal lpRootPathName As Long, _
  ...
  Private Declare Function CreateDirectory _
                  Lib "kernel32" _
                  Alias "CreateDirectoryW" (ByVal lpPathName As Long, _
                                            ByVal lpSecurityAttributes As Long) As Long

  Private Declare Function RemoveDirectory _
                  Lib "kernel32" _
                  Alias "RemoveDirectoryW" (ByVal lpPathName As Long) As Long

  Private Declare Function GetFileVersionInfo _
                  Lib "Version" _
                  Alias "GetFileVersionInfoW" (ByVal lpFileName As Long, _
  ...
  Private Declare Function GetFileVersionInfoSize _
                  Lib "Version" _
                  Alias "GetFileVersionInfoSizeW" (ByVal lpFileName As Long, _
                                                   ByVal lpdwHandle As Long) As Long

  Private Declare Function VerQueryValue _
                  Lib "Version" _
                  Alias "VerQueryValueW" (ByVal lpBlock As Long, _
  ...
  Private Declare Function PathGetArgs _
                  Lib "shlwapi" _
                  Alias "PathGetArgsW" (ByVal lpszPath As Long) As Long

  Private Declare Function SysReAllocString _
                  Lib "oleaut32" (ByVal pbString As Long, _
                                  ByVal pszStrPtr As Long) As Long

  Private Declare Function VarDecFromI8 _
                  Lib "oleaut32" (ByVal i64In As Currency, _
                                  ByRef pDecOut As Variant) As Long
  ...
  Private Declare Function GetWindowText _
                  Lib "user32" _
                  Alias "GetWindowTextW" (ByVal hWnd As Long, _
                                          ByVal lpString As Long, _
                                          ByVal cch As Long) As Long

  Private Declare Function GetWindowTextLength _
                  Lib "user32" _
                  Alias "GetWindowTextLengthW" (ByVal hWnd As Long) As Long
  ...
  Private Declare Function GetSystemWindowsDirectory _
                  Lib "kernel32" _
                  Alias "GetSystemWindowsDirectoryW" (ByVal lpBuffer As Long, _
                                                      ByVal nSize As Long) As Long

  Private Declare Function GetSystemDirectory _
                  Lib "kernel32" _
                  Alias "GetSystemDirectoryW" (ByVal lpBuffer As Long, _
                                               ByVal nSize As Long) As Long
  ...
  Private Declare Function GetObjectAPI _
                  Lib "gdi32" _
                  Alias "GetObjectW" (ByVal hObject As Long, _
  ...
  Private Declare Function GdiAlphaBlend _
  ...
  Private Declare Function CreateFontIndirect _
                  Lib "gdi32" _
                  Alias "CreateFontIndirectW" (ByRef lpLogFont As LOGFONT) As Long
  ...
  Private Declare Function OleTranslateColor _
                  Lib "oleaut32" (ByVal Color As Long, _
                                  ByVal hPal As Long, _
                                  ByRef RGBResult As Long) As Long

  Private Declare Function OleLoadPicture _
                  Lib "oleaut32" (ByVal pStream As IUnknown, _
                                  ByVal lSize As Long, _
                                  ByVal fRunmode As Long, _
                                  ByRef riid As Any, _
                                  ByRef pIPicture As IPicture) As Long

  Private Declare Function OleLoadPicturePath _
                  Lib "oleaut32" (ByVal lpszPath As Long, _
                                  ByVal pUnkCaller As Long, _
                                  ByVal dwReserved As Long, _
                                  ByVal ClrReserved As Long, _
                                  ByRef riid As CLSID, _
                                  ByRef pIPicture As IPicture) As Long

  Private Declare Function OleCreatePictureIndirect _
                  Lib "oleaut32" (ByRef pPictDesc As PICTDESC, _
                                  ByRef riid As Any, _
  ...
  Private Declare Function CreateStreamOnHGlobal _
                  Lib "ole32" (ByVal hGlobal As Long, _
                               ...
                               ByRef pStream As IUnknown) As Long
  ...
  Private Declare Function WinHelp _
                  Lib "user32" _
                  Alias "WinHelpW" (ByVal hWnd As Long, _
                                    ByVal lpHelpFile As Long, _
                                    ByVal wCommand As Long, _
                                    ByVal dwData As Long) As Long

  Private Declare Function HtmlHelp _
                  Lib "hhctrl.ocx" _
                  Alias "HtmlHelpW" (ByVal hWndCaller As Long, _
...
#If VBA7 Then
  Public Function MsgBox(ByVal Prompt As String, _
                         ...
                         Optional ByVal ResIcon As Variant, _
                         Optional ByVal hWnd As LongPtr) As VbMsgBoxResult
  #Else
...
' (VB-Overwrite)
Public Function Dir(Optional ByVal PathMask As String, _
...
Public Function OLEFontIsEqual(ByVal Font As StdFont, _
                               ByVal FontOther As StdFont) As Boolean
  ...
  Else
    ...
    If Font.Name = FontOther.Name And Font.Size = FontOther.Size And Font.Charset = FontOther.Charset And Font.Weight = FontOther.Weight And Font.Underline = FontOther.Underline And Font.Italic = FontOther.Italic And Font.Strikethrough = FontOther.Strikethrough Then
      OLEFontIsEqual = True
    End If
  End If
...
#If VBA7 Then
  Public Function CreateGDIFontFromOLEFont(ByVal Font As IFont, _
                                           Optional ByVal Quality As Long) As LongPtr
  #Else
...
#If (TWINBASIC = 0) Then
  Public Function Nz(ByRef Value As Variant, _
                     Optional ByRef ValueIfNull As Variant = Empty) As Variant
...
#If VBA7 Then
  Public Function PictureFromHandle(ByVal Handle As LongPtr, _
                                    ByVal PicType As VBRUN.PictureTypeConstants) As IPictureDisp
  #Else
...
#If VBA7 Then
  Public Function BitmapHandleFromPicture(ByVal Picture As IPictureDisp, _
                                          Optional ByVal BackColor As Long) As LongPtr
  #Else
...
#If VBA7 Then
  Public Sub RenderPicture(ByVal Picture As IPicture, _
                           ByVal hDC As LongPtr, _
                           ByVal X As Long, _
                           ByVal Y As Long, _
                           Optional ByVal CX As Long, _
                           Optional ByVal CY As Long, _
                           Optional ByRef RenderFlag As Integer)
  #Else
