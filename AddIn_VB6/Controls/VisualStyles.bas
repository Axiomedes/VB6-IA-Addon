...
#Else
  ...
  Public Declare Function ActivateVisualStyles _
                 Lib "uxtheme" _
                 Alias "SetWindowTheme" (ByVal hWnd As Long, _
                                         Optional ByVal pszSubAppName As Long = 0, _
                                         Optional ByVal pszSubIdList As Long = 0) As Long

  Public Declare Function RemoveVisualStyles _
                 Lib "uxtheme" _
                 Alias "SetWindowTheme" (ByVal hWnd As Long, _
                                         Optional ByRef pszSubAppName As String = " ", _
                                         Optional ByRef pszSubIdList As String = " ") As Long

  Public Declare Function GetVisualStyles _
                 Lib "uxtheme" _
                 Alias "GetWindowTheme" (ByVal hWnd As Long) As Long
#End If
...
#Else
  ...
  Private Declare Function DrawState _
                  Lib "user32" _
                  Alias "DrawStateW" (ByVal hDC As Long, _
  ...
  Private Declare Function BeginPaint _
                  Lib "user32" (ByVal hWnd As Long, _
                                ByRef lpPaint As PAINTSTRUCT) As Long

  Private Declare Function EndPaint _
                  Lib "user32" (ByVal hWnd As Long, _
                                ByRef lpPaint As PAINTSTRUCT) As Long
  ...
  Private Declare Function DrawText _
                  Lib "user32" _
                  Alias "DrawTextW" (ByVal hDC As Long, _
  ...
  Private Declare Function TransparentBlt _
                  Lib "msimg32" (ByVal hDestDC As Long, _
                                 ByVal X As Long, _
                                 ByVal Y As Long, _
  ...
  Private Declare Function GetThemeBackgroundContentRect _
                  Lib "uxtheme" (ByVal Theme As Long, _
                                 ...
                                 ByRef pContentRect As RECT) As Long
...
Private Function RedirectFrame(ByVal hWnd As LongPtr, _
                               ByVal wMsg As Long, _
...
Private Function RedirectButton(ByVal hWnd As LongPtr, _
                                ByVal wMsg As Long, _
                                ByVal wParam As LongPtr, _
                                ByVal lParam As LongPtr, _
                                ByVal uIdSubclass As LongPtr, _
                                ByVal Button As Object) As LongPtr
...
Private Sub DrawButton(ByVal hWnd As LongPtr, _
                       ByVal hDC As LongPtr, _
                       ByVal Button As Object)
...
Private Function CoalescePicture(ByVal Picture As IPictureDisp, _
                                 ByVal DefaultPicture As IPictureDisp) As IPictureDisp
