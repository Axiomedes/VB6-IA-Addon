...
#Else
  ...
  Private Declare Function DispCallFunc _
                  Lib "oleaut32" (ByVal lpvInstance As Long, _
  ...
  Private Declare Function VariantCopy _
                  Lib "oleaut32" (ByRef pvargDest As Any, _
...
Public Function SetVTableHandling(ByVal This As Object, _
                                  ByVal OLEInterface As VTableInterfaceConstants) As Boolean
...
Public Function RemoveVTableHandling(ByVal This As Object, _
                                     ByVal OLEInterface As VTableInterfaceConstants) As Boolean
...
Private Function VTableHandlingSupported(ByRef This As Object, _
                                         ByVal OLEInterface As VTableInterfaceConstants) As Boolean
...
#If VBA7 Then
  Public Function VTableCall(ByVal RetType As VbVarType, _
                             ByVal InterfacePointer As LongPtr, _
                             ByVal Entry As LongPtr, _
                             ParamArray ArgList() As Variant) As Variant
  #Else
...
Public Function VTableInterfaceSupported(ByVal This As OLEGuids.IUnknownUnrestricted, _
                                         ByVal IIDString As String) As Boolean
...
#If (TWINBASIC = 0) Then
  Public Function CallByDispId(ByVal This As Object, _
...
Private Function IOleIPAO_QueryInterface(ByRef This As VTableIPAODataStruct, _
                                         ByRef IID As OLEGuids.OLECLSID, _
...
Private Function IOleIPAO_GetWindow(ByRef This As VTableIPAODataStruct, _
                                    ByRef hWnd As LongPtr) As Long
  IOleIPAO_GetWindow = This.OriginalIOleIPAO.GetWindow(hWnd)
End Function

Private Function IOleIPAO_ContextSensitiveHelp(ByRef This As VTableIPAODataStruct, _
                                               ByVal EnterMode As Long) As Long
  IOleIPAO_ContextSensitiveHelp = This.OriginalIOleIPAO.ContextSensitiveHelp(EnterMode)
End Function

Private Function IOleIPAO_TranslateAccelerator(ByRef This As VTableIPAODataStruct, _
                                               ByRef Msg As OLEGuids.OLEACCELMSG) As Long
...
Private Function IOleIPAO_OnFrameWindowActivate(ByRef This As VTableIPAODataStruct, _
                                                ByVal Activate As Long) As Long
  IOleIPAO_OnFrameWindowActivate = This.OriginalIOleIPAO.OnFrameWindowActivate(Activate)
End Function

Private Function IOleIPAO_OnDocWindowActivate(ByRef This As VTableIPAODataStruct, _
                                              ByVal Activate As Long) As Long
  IOleIPAO_OnDocWindowActivate = This.OriginalIOleIPAO.OnDocWindowActivate(Activate)
End Function

Private Function IOleIPAO_ResizeBorder(ByRef This As VTableIPAODataStruct, _
                                       ByRef RC As OLEGuids.OLERECT, _
                                       ByVal UIWindow As OLEGuids.IOleInPlaceUIWindow, _
                                       ByVal FrameWindow As Long) As Long
  IOleIPAO_ResizeBorder = This.OriginalIOleIPAO.ResizeBorder(VarPtr(RC), UIWindow, FrameWindow)
End Function

Private Function IOleIPAO_EnableModeless(ByRef This As VTableIPAODataStruct, _
...
Private Function IOleControl_GetControlInfo(ByRef This As LongPtr, _
                                            ByRef CI As OLEGuids.OLECONTROLINFO) As Long
...
Private Function IOleControl_OnMnemonic(ByRef This As LongPtr, _
                                        ByRef Msg As OLEGuids.OLEACCELMSG) As Long
...
Private Function IOleControl_OnAmbientPropertyChange(ByRef This As LongPtr, _
                                                     ByVal DispId As Long) As Long
  IOleControl_OnAmbientPropertyChange = Original_IOleControl_OnAmbientPropertyChange(This, DispId)
End Function

Private Function IOleControl_FreezeEvents(ByRef This As LongPtr, _
                                          ByVal bFreeze As Long) As Long
  IOleControl_FreezeEvents = Original_IOleControl_FreezeEvents(This, bFreeze)
End Function

Private Function Original_IOleControl_GetControlInfo(ByRef This As LongPtr, _
                                                     ByRef CI As OLEGuids.OLECONTROLINFO) As Long
...
Private Function Original_IOleControl_OnMnemonic(ByRef This As LongPtr, _
                                                 ByRef Msg As OLEGuids.OLEACCELMSG) As Long
...
Private Function Original_IOleControl_OnAmbientPropertyChange(ByRef This As LongPtr, _
                                                              ByVal DispId As Long) As Long
...
Private Function Original_IOleControl_FreezeEvents(ByRef This As LongPtr, _
                                                   ByVal bFreeze As Long) As Long
...
Private Function IPPB_GetDisplayString(ByRef This As LongPtr, _
                                       ByVal DispId As Long, _
                                       ByRef lpDisplayName As LongPtr) As Long
...
Private Function IPPB_MapPropertyToPage(ByRef This As LongPtr, _
                                        ByVal DispId As Long, _
                                        ByRef pCLSID As OLEGuids.OLECLSID) As Long
  IPPB_MapPropertyToPage = Original_IPPB_MapPropertyToPage(This, DispId, pCLSID)
End Function

Private Function IPPB_GetPredefinedStrings(ByRef This As LongPtr, _
                                           ByVal DispId As Long, _
                                           ByRef pCaStringsOut As OLEGuids.OLECALPOLESTR, _
                                           ByRef pCaCookiesOut As OLEGuids.OLECADWORD) As Long
...
Private Function IPPB_GetPredefinedValue(ByRef This As LongPtr, _
                                         ByVal DispId As Long, _
                                         ByVal dwCookie As Long, _
                                         ByRef pVarOut As Variant) As Long
...
Private Function Original_IPPB_GetDisplayString(ByRef This As LongPtr, _
                                                ByVal DispId As Long, _
                                                ByRef lpDisplayName As LongPtr) As Long
...
Private Function Original_IPPB_MapPropertyToPage(ByRef This As LongPtr, _
                                                 ByVal DispId As Long, _
                                                 ByRef pCLSID As OLEGuids.OLECLSID) As Long
...
Private Function Original_IPPB_GetPredefinedStrings(ByRef This As LongPtr, _
                                                    ByVal DispId As Long, _
                                                    ByRef pCaStringsOut As OLEGuids.OLECALPOLESTR, _
                                                    ByRef pCaCookiesOut As OLEGuids.OLECADWORD) As Long
...
Private Function Original_IPPB_GetPredefinedValue(ByRef This As LongPtr, _
                                                  ByVal DispId As Long, _
                                                  ByVal dwCookie As Long, _
                                                  ByRef pVarOut As Variant) As Long
...
Private Function InPlaceObjectWindowless_OnWindowMessage(ByRef This As LongPtr, _
...
Private Function InPlaceObjectWindowless_GetDropTarget(ByRef This As LongPtr, _
                                                       ByRef lppDropTarget As LongPtr) As Long
  InPlaceObjectWindowless_GetDropTarget = Original_InPlaceObjectWindowless_GetDropTarget(This, lppDropTarget)
End Function

Private Function Original_InPlaceObjectWindowless_OnWindowMessage(ByRef This As LongPtr, _
                                                                  ByVal wMsg As Long, _
                                                                  ByVal wParam As LongPtr, _
                                                                  ByVal lParam As LongPtr, _
                                                                  ByRef Result As LongPtr) As Long
...
Private Function Original_InPlaceObjectWindowless_GetDropTarget(ByRef This As LongPtr, _
                                                                ByRef lppDropTarget As LongPtr) As Long
...
Public Function GetNewEnum(ByVal This As Object, _
                           ByVal Upper As Long, _
                           ByVal Lower As Long) As IEnumVARIANT
...
Private Function IEnumVARIANT_QueryInterface(ByRef This As VTableEnumVARIANTDataStruct, _
                                             ByRef IID As OLEGuids.OLECLSID, _
                                             ByRef pvObj As LongPtr) As Long
...
Private Function IEnumVARIANT_Next(ByRef This As VTableEnumVARIANTDataStruct, _
                                   ByVal VntCount As Long, _
                                   ByVal VntArrPtr As LongPtr, _
                                   ByRef pcvFetched As Long) As Long
...
Private Function IEnumVARIANT_Skip(ByRef This As VTableEnumVARIANTDataStruct, _
                                   ByVal VntCount As Long) As Long
...
Private Function IEnumVARIANT_Clone(ByRef This As VTableEnumVARIANTDataStruct, _
                                    ByRef ppEnum As IEnumVARIANT) As Long
