...
#If VBA7 Then
  Public Function RtfStreamCallbackStringOut(ByVal dwCookie As LongPtr, _
                                             ByVal ByteBufferPtr As LongPtr, _
                                             ByVal BytesRequested As Long, _
                                             ByRef BytesProcessed As Long) As Long
  #Else
...
#If VBA7 Then
  Public Function RtfStreamCallbackStringIn(ByVal dwCookie As LongPtr, _
                                            ByVal ByteBufferPtr As LongPtr, _
                                            ByVal BytesRequested As Long, _
                                            ByRef BytesProcessed As Long) As Long
  #Else
...
#If VBA7 Then
  Public Function RtfStreamCallbackFileOut(ByVal dwCookie As LongPtr, _
                                           ByVal ByteBufferPtr As LongPtr, _
                                           ByVal BytesRequested As Long, _
                                           ByRef BytesProcessed As Long) As Long
  #Else
...
#If VBA7 Then
  Public Function RtfStreamCallbackFileIn(ByVal dwCookie As LongPtr, _
                                          ByVal ByteBufferPtr As LongPtr, _
                                          ByVal BytesRequested As Long, _
                                          ByRef BytesProcessed As Long) As Long
  #Else
...
Private Function IRichEditOleCallback_QueryInterface(ByRef This As VTableIRichEditOleCallbackDataStruct, _
...
Private Function IRichEditOleCallback_GetNewStorage(ByRef This As VTableIRichEditOleCallbackDataStruct, _
                                                    ByRef ppStorage As OLEGuids.IStorage) As Long
...
Private Function IRichEditOleCallback_GetInPlaceContext(ByRef This As VTableIRichEditOleCallbackDataStruct, _
                                                        ByRef ppFrame As OLEGuids.IOleInPlaceFrame, _
                                                        ByRef ppDoc As OLEGuids.IOleInPlaceUIWindow, _
                                                        ByRef pFrameInfo As OLEGuids.OLEINPLACEFRAMEINFO) As Long
  IRichEditOleCallback_GetInPlaceContext = E_NOTIMPL
End Function

Private Function IRichEditOleCallback_ShowContainerUI(ByRef This As VTableIRichEditOleCallbackDataStruct, _
                                                      ByVal fShow As Long) As Long
  IRichEditOleCallback_ShowContainerUI = E_NOTIMPL
End Function

Private Function IRichEditOleCallback_QueryInsertObject(ByRef This As VTableIRichEditOleCallbackDataStruct, _
                                                        ByRef pCLSID As OLEGuids.OLECLSID, _
                                                        ByVal pStorage As OLEGuids.IStorage, _
                                                        ByVal CharPos As Long) As Long
  IRichEditOleCallback_QueryInsertObject = S_OK
End Function

Private Function IRichEditOleCallback_DeleteObject(ByRef This As VTableIRichEditOleCallbackDataStruct, _
                                                   ByVal LpOleObject As LongPtr) As Long
...
Private Function IRichEditOleCallback_QueryAcceptData(ByRef This As VTableIRichEditOleCallbackDataStruct, _
                                                      ByVal pDataObject As OLEGuids.IDataObject, _
                                                      ByRef CF As Integer, _
                                                      ByVal RECO As Long, _
                                                      ByVal fReally As Long, _
                                                      ByVal hMetaPict As LongPtr) As Long
  IRichEditOleCallback_QueryAcceptData = E_NOTIMPL
End Function

Private Function IRichEditOleCallback_ContextSensitiveHelp(ByRef This As VTableIRichEditOleCallbackDataStruct, _
                                                           ByVal fEnterMode As Long) As Long
  IRichEditOleCallback_ContextSensitiveHelp = E_NOTIMPL
End Function

Private Function IRichEditOleCallback_GetClipboardData(ByRef This As VTableIRichEditOleCallbackDataStruct, _
...
Private Function IRichEditOleCallback_GetDragDropEffect(ByRef This As VTableIRichEditOleCallbackDataStruct, _
                                                        ByVal fDrag As Long, _
                                                        ByVal KeyState As Long, _
                                                        ByRef dwEffect As Long) As Long
...
Private Function IRichEditOleCallback_GetContextMenu(ByRef This As VTableIRichEditOleCallbackDataStruct, _
                                                     ByVal SelType As Integer, _
                                                     ByVal LpOleObject As LongPtr, _
                                                     ByVal lpCharRange As LongPtr, _
                                                     ByRef hMenu As LongPtr) As Long
